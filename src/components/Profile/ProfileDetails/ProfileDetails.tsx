...
const ProfileDetails: FC<{ profile: IUserData }> = ({
  profile,
}): ReactElement => {
                ...
                onSubmit={(value) => {
                  ...
                  if (
                    !(
                      ...
                      manualCheck[0].length === 2 &&
                      manualCheck[1].length === 2 &&
                      manualCheck[2].length === 4
                    ) ||
              ...
              >
                <FormControl isInvalid={errors.dateOfBirthError}>
                  <VStack align="start">
                    ...
                    <FormErrorMessage textAlign="start">
                      Date of birth must be valid and in &apos;DD/MM/YYYY&apos;
                      format.
                    </FormErrorMessage>
                  </VStack>
                </FormControl>
